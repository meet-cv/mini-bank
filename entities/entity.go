...
type Account struct {
	...
	Account_Balance float64   `pg:"acc_balance, notnull, type:numeric(10,2), default:0" json:"acc_balance" validate:"numeric"`
	Created_At      time.Time `pg:"created_at, notnull, type:timestamp, default:now()" json:"created_at" validate:"datetime"`
	Updated_At      time.Time `pg:"updated_at, type:timestamp" json:"updated_at" validate:"datetime"`
}
...
type AccountHolder struct {
	...
	User_Id    int      `pg:"user_id, type:int" json:"user_id" validate:"number"`
	Account_Id int      `pg:"acc_id, type:int" json:"acc_id" validate:"number"`
}
...
type Transaction struct {
	...
	Transaction_Amount float64   `pg:"transac_amount, notnull, type:numeric(10,2)" json:"transac_amount" validate:"numeric"`
